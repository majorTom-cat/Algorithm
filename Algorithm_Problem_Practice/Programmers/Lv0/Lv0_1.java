...
//유의사항
//네 가지를 붙여 만들 수 있는 발음 이외에는 어떤 발음도 할 수 없는 것으로 규정합니다. 예를 들어 "woowo"는 "woo"는 발음할 수 있지만
...
public class Lv0_1 {
	...
	public static void main(String[] args) {
		ArrayList<String> babblingArray = new ArrayList<String>();
		babblingArray.add("aya");
		babblingArray.add("ye");
		babblingArray.add("woo");
		babblingArray.add("ma");
	}
